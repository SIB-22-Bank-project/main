...
#manager add date
    while True:
        ...
        try:
            ...
            elif age(birth_date)-age(add_date)>=20:
                break
            else:
                print("manager must atleast be 20 years of age!!")
    ...
    try:
        ...
        while True:
            ...
            if lp>8:
                ...
                try:
                    cur.execute("INSERT INTO empass values({},LPAD({},{},'0'))".format(manager_no,password,lp))
                    query.commit()
                except mysql.connector.Error as err:
                    print(err.msg)
